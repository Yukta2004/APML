...
// let formattedUS = (Intl.DateTimeFormat(locale,options).found(now))
// console.log(formattedUS);

// console.log(new Intl.DateTimeFormat('en-GB', { dateStyle: 'full', timeStyle: 'long'}).format(now));
